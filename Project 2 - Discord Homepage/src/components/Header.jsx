...
const Header = ({ imageUrl }) => {
  return (
    <header className="bg-discord_blue w-full flex justify-center items-center relative">
      ...
      >
        <Navbar />
        <div className="flex flex-col items-center lg:justify-center h-fit lg:mt-20 relative">
          <div className="hero_text text-white flex flex-col justify-center items-center text-center p-5">
            {hero_text.map((d, index) => (
              <div key={index} className="flex flex-col lg:items-center items-start space-y-11">
                <div className="black-ops-one-regular md:text-5xl lg:text-6xl text-3xl text-center">
                  {d.Heading.toUpperCase()}
                </div>
                <div className="lg:text-xl lg:w-[40vw] space-x-12 tracking-widest lg:text-center">
                  {d.description}
                </div>
              </div>
            ))}
          ...
          <div className="btns">
            <div className="lg:flex lg:flex-row flex-col lg:space-y-0 lg:space-x-4 space-y-5 w-fit">
              ...
              <Button
                content="Download Discord to talk, chat, and hang out"
      ...
      <div className="hero_image">
        ...
        <img src="../../assets/hero_home_image_2.svg" alt="" className="lg:absolute bottom-0 right-0 md:w-[30vw] lg:w-[30vw] w-0" />
      </div>
    </header>
  );
};
